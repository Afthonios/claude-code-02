    ...
    try {
      ...
      return NextResponse.json(data, {
        headers: {
          ...
          // Add cache headers - competences change less frequently than courses
          'Cache-Control': 'public, max-age=600, stale-while-revalidate=1800', // Cache 10 minutes, stale for 30 minutes
